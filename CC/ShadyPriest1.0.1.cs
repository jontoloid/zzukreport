...
namespace ShadyForm
{
    public class ShadyForm : CustomClass
    {
        ...
        public override void Fight()
        {
            ...
            if (this.Player.GetSpellRank("Shadow Word: Pain") != 0 && this.Target.HealthPercent >= 3 && this.Player.ManaPercent >= 10)
            {
            ...
            {
                if (this.Player.CanUse("Mind Flay") && this.Target.HealthPercent >= 55 && this.Player.IsChanneling != "Mind Flay" && this.Player.IsCasting != "Mind Flay" && this.Player.ManaPercent >= 10)
                {
                    this.Player.StopWand();
            ...
            if (this.Player.ManaPercent < 10 || this.Target.HealthPercent < 55)
            {
        ...
        public override void Rest()
        {
            ...
            if (this.Player.ManaPercent < 15 & !this.Player.GotBuff("Drink"))
            {
                SelectDrink();
                return;
            }
