...
namespace something
{
    public class ShadyForm : CustomClass
    {
        ...
        public override void Fight()
        {
            ...
            if (this.Player.GetSpellRank("Shadow Word: Pain") != 0 && this.Target.HealthPercent >= 3)
            {
            ...
            {
                this.Player.StopWand();
                if (this.Player.GetSpellRank("Flash Heal") != 0 && this.Player.ManaPercent >= 85 && this.Player.HealthPercent <= 30)
                {
            ...
            {
                if (!this.Player.GotBuff("Power Word: Shield") && !this.Player.GotDebuff("Weakened Soul") && this.Player.IsChanneling != "Mind Flay" && this.Player.IsCasting != "Mind Flay")
                {
                    this.Player.StopWand();
            ...
            {
                if (this.Player.CanUse("Mind Flay") && this.Target.HealthPercent >= 50 && this.Player.IsChanneling != "Mind Flay" && this.Player.IsCasting != "Mind Flay")
                {
                    this.Player.StopWand();
            ...
            if (this.Player.ManaPercent < 10 || this.Target.HealthPercent <= 50)
            {
        ...
        public override void Rest()
        {
            ...
            {
                //I have right now opted to use Lesser Heal exclusively, since it does not seem like I require any other more mana intense heal.
